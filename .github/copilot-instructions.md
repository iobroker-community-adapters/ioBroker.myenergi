...
- **Adapter Name**: iobroker.myenergi
- **Primary Function**: Connect ioBroker to myenergi smart energy devices (Zappi, Eddi, Harvi)
- **Key Dependencies**: myenergi cloud API (digest authentication), json2iob helper
- **Configuration Requirements**: Hub serial number (username), API key (password), polling interval
